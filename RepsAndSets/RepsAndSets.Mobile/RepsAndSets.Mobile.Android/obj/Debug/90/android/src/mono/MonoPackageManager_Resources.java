...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "RepsAndSets.Mobile.Android.dll" comes first in this list. */
		"RepsAndSets.Mobile.Android.dll",
		"RepsAndSets.Library.dll",
		"Dapper.dll",
		"FormsViewGroup.dll",
		"RepsAndSets.Mobile.dll",
